...
class PresensiLabAplikasiProfesional extends Component
{
    public $rfid = '';
    public $name = '';
    ...
    public function schedule()
    {
        ...
        return Schedule::with('group', 'period', 'period.day', 'room')
            ->whereHas('room', function ($query) {
                $query->where('name', 'Aplikasi Profesional');
            })
    ...
    {
        return view('livewire.presensi-lab-aplikasi-profesional')
            ->layout(AppLayout::class, ['title' => 'Presensi Lab Aplikasi Profesional']);
    }
}
